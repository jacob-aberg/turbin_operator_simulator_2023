...
% GUI - element
    ...
    turbolens_label = uicontrol(main_figure, 'Style', 'text', ...
                                    'String', sprintf('Turbolens: 0.00'), ...
                                    'Position', [vxy-[0,40], 300, 20], 'FontSize',11);
    turbolens_slider = uicontrol('Style', 'slider', 'Min', 0, 'Max', 2, ...
                       'Value', 0, 'Position', [vxy-[0,60], 300, 20] ...
                       );
...
% uppdaterar GUI-element
    ...
    set(turbolens_label, 'String', sprintf('Turbolens: '+string(turbolens)));
